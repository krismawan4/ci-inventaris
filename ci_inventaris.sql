...
--
-- Host: localhost
-- Waktu pembuatan: 17 Bulan Mei 2021 pada 21.34
-- Versi server: 8.0.22
-- Versi PHP: 7.3.27
...
--
-- Dumping data untuk tabel `tb_switch`
--
...
(1, 'Krismawan Riki', 'krismawan4', '$2y$10$.SFAy9l7KDeCmtvHwVObCOr/wp1kjr5njvKnGKRWcBy23oI/YY.Vq');
...
--
ALTER TABLE `tb_jaringan`
  MODIFY `id_jaringan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT untuk tabel `tb_lokasi`
--
ALTER TABLE `tb_lokasi`
  MODIFY `id_lokasi` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tb_pc`
  MODIFY `no_urut` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT untuk tabel `tb_printer`
--
ALTER TABLE `tb_printer`
  MODIFY `id_printer` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT untuk tabel `tb_switch`
--
ALTER TABLE `tb_switch`
  MODIFY `id_switch` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
-- Ketidakleluasaan untuk tabel `tb_jaringan`
--
ALTER TABLE `tb_jaringan`
