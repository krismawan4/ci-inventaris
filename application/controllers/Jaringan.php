...
Class Jaringan extends CI_Controller {
    ...
    function cetak() {
        ...
        $pdf->Image('assets/images/icon/hss.png',1.5,0.7,2,2);
        $pdf->SetX(4);
        $pdf->MultiCell(19.5,0.5,'RS SKP 17.1 HOSPITAL',0,'L');
        $pdf->SetX(4);
        $pdf->MultiCell(19.5,0.5,'Telp : +62 021-4403026',0,'L');
        $pdf->SetFont('Arial', 'B', 10);
        $pdf->SetX(4);
        $pdf->MultiCell(19.5,0.5,'Website : www.skp171hospital.com' ,0,'L');
        $pdf->SetX(4);
        $pdf->MultiCell(26.5,0.5,'Email : info@skp171hospital.com',0,'L');
